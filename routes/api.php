 ...
 */
Route::get('/themes/{userId}/user', [ThemeController::class, 'getThemesByUser'])->middleware('auth:sanctum');
 ...
 */
Route::get('/cartes/{themeId}/user', [CardController::class, 'getCardsByThemeForUser'])->middleware('auth:sanctum');
...
/**
 * Route pour séléctionner le nombre de cartes à réviser pour aujourd'hui ✅
 */
Route::post('/revision/nombre-cartes', [RevisionController::class, 'getCardsForToday'])->middleware('auth:sanctum');
...
/**
 * Route pour mettre à jour le niveau d'une carte qui est révisée ✅
 */
Route::put('/revision', [RevisionController::class, 'updateRevision'])->middleware('auth:sanctum');
 ...
 */
Route::delete('/revision/deleteAll', [RevisionController::class, 'deleteAllRevision'])->middleware('auth:sanctum');
...
/**
 * Route de test pour envoyer une notification push ⚗️
 */
 ...
 * si c'est le user que j'ai créé qui est le premier dans la table sinon utiliser sendNotification ⚗️
 */
